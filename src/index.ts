...
async function handleHome(env: Env, url: URL): Promise<Response> {
  ...
  <div class="donate-wrap">
    ...
    <script>
    (function () {
      // Keep the bmc-button widget purely for its look -- point the link it
      // renders at PayPal instead of Buy Me a Coffee.
      var link = document.querySelector(".donate-wrap .bmc-btn");
      if (link) link.href = "https://paypal.me/JoeyShapiroDev";
    })();
    </script>
  </div>
</header>
